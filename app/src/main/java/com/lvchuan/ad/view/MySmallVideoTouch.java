 ...
 * 小窗口触摸移动
 */
public class MySmallVideoTouch implements View.OnTouchListener {

    private int mDownX, mDownY;
    private int mMarginLeft, mMarginTop;
    private int _xDelta, _yDelta;
    private MyGSYBaseVideoPlayer mGsyBaseVideoPlayer;


    public MySmallVideoTouch(MyGSYBaseVideoPlayer gsyBaseVideoPlayer, int marginLeft, int marginTop) {
        super();
