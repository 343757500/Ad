...
public class MyOrientationUtils {
    ...
    private MyGSYBaseVideoPlayer mVideoPlayer;
     ...
     */
    public MyOrientationUtils(Activity activity, MyGSYBaseVideoPlayer gsyVideoPlayer) {
        this(activity, gsyVideoPlayer, null);
    }

    public MyOrientationUtils(Activity activity, MyGSYBaseVideoPlayer gsyVideoPlayer, OrientationOption orientationOption) {
