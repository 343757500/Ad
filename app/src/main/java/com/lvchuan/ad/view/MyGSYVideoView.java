...
public abstract class MyGSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    public MyGSYVideoView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    protected void onLossAudio() {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public void run() {
                if (MyGSYVideoView.this.mReleaseWhenLossAudio) {
                    MyGSYVideoView.this.releaseVideos();
                } else {
