...
public class MyStandardGSYVideoPlayer extends MyGSYVideoPlayer {
    ...
    public MyStandardGSYVideoPlayer(@NonNull Context context) {
        super(context);
    }

    public MyStandardGSYVideoPlayer(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MyStandardGSYVideoPlayer(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    @Override
    public MyGSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        MyGSYBaseVideoPlayer gsyBaseVideoPlayer = super.startWindowFullscreen(context, actionBar, statusBar);
    ...
    protected void changeUiToNormal() {
        ...
        setViewShowState(mLockScreen, (mIfCurrentIsFullscreen && mNeedLockFull) ? INVISIBLE : GONE);
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(MyStandardGSYVideoPlayer standardGSYVideoPlayer) {
