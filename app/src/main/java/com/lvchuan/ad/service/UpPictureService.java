...
import com.lvchuan.ad.utils.ScreenCaptureUtil;
...
public class UpPictureService extends Service {
    ...
    //是否保活权限
    private final void permissionAlive() {
        FileUtil fileUtil = new FileUtil(UpPictureService.this);
        try {
            ...
            Log.e("UpPcitureService",e.getMessage());
        }
    }
